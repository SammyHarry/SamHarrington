...
export default function GenAIPage() {
  ...
  const data = yaml.parse(file) as { completion: number; total: number; items: Item[] };
  return (
    <div className="py-16">
      <SectionHeader
        eyebrow="16 Things in 93 Days"
        title={`✅ ${data.completion}/${data.total} Completed`}
        blurb="Accelerated program applying Generative AI across communication, coding, data, creativity, productivity, and more."
      />
